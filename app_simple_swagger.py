"""
Local Advanced Prompting System - Flask API with Simple Swagger UI
Using Flasgger for easy Swagger integration
"""
...
def create_app():
    """Create and configure Flask application with Flasgger Swagger UI"""
    app = Flask(__name__)
    ...
    # API info endpoint with Swagger documentation
